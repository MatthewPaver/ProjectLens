...
A traffic-light rating tells you where a project is now.

It rarely tells you what changed, why it changed or what happened to similar projects next.

I originally built ProjectLens as a polished schedule-risk demonstration. When I reviewed it properly, I found the important flaw: the public demo was still relying on synthetic schedules.
